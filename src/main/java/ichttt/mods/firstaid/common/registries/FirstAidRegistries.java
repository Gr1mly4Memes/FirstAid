...
import ichttt.mods.firstaid.common.loot.FirstAidChestLootModifier;
...
public final class FirstAidRegistries {
    ...
    static final DeferredRegister<MapCodec<? extends IGlobalLootModifier>> DEFERRED_LOOT_MODIFIERS =
            DeferredRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, FirstAid.MODID);
    public static final Supplier<MapCodec<FirstAidChestLootModifier>> CHEST_LOOT =
            DEFERRED_LOOT_MODIFIERS.register("chest_loot", () -> FirstAidChestLootModifier.CODEC);
    ...
    public static void setup(IEventBus modEventBus) {
        ...
        DEFERRED_LOOT_MODIFIERS.register(modEventBus);
