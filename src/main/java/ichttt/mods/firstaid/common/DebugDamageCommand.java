...
public class DebugDamageCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        LiteralArgumentBuilder<CommandSourceStack> builder = Commands.literal("damagePart").requires(Commands.hasPermission(Commands.LEVEL_GAMEMASTERS));
    ...
    private static int handleCommand(EnumPlayerPart part, float damage, boolean debuff, ServerPlayer player) throws CommandSyntaxException {
        ...
        //make sure to resync the client
        PacketDistributor.sendToPlayer(player, new MessageSyncDamageModel(damageModel, false));
        return 1;
    }
